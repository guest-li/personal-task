...
export default async function UniversitiesPage({
  ...
  const result = await listUniversitiesAdmin(page, 20, {
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <div className="flex gap-2">
          {result.pagination.page > 1 && (
            <Link
              href={`?page=${result.pagination.page - 1}${searchParams.search ? `&search=${searchParams.search}` : ""}${searchParams.province ? `&province=${searchParams.province}` : ""}`}
